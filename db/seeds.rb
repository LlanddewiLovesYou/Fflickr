...
album1 = Album.create({title: 'Corgis!', description: 'Cutest doggos by a mile!', user_id: user2.id})
album2 = Album.create({title: 'Peak\'s Island ME', description: 'We took the ferry to Peak\'s Island, We are those people', user_id: user2.id})
album3 = Album.create({title: 'FEN by Caryl Churchill', description: 'USC MFA Program', user_id: user2.id})

photo1 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/corgi1.jpg', user_id: user2.id, caption: 'so floof!', title: 'Floofy Corgo'} )
...
photo2 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/corgi2.JPG', user_id: user2.id, caption: 'This is my fave!', title: 'Super Fly Corgo'})
...
photo3 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/corgi3.jpg', user_id: user2.id, caption: 'Such Corgo!', title: 'So many Corgo!' })
...
photo4 = Photo.create!({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/corgi4.jpg', user_id: user2.id, caption: 'The pumpkin spice must flow!',  title: 'Pumpkin Spice Corgo'})
...
photo5 = Photo.create!({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/corgi5.jpg', user_id: user2.id, caption: 'so squish!', title: 'Special Delivery: Corgo!'})
...
comment11 = Comment.create({body:'Mine must have gotten lost in the mail :(', photo_id: photo5.id, user_id: user2.id} )


photo6 = Photo.create!({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/Peaks1.jpg', title: 'Peak\'s Island and Fort Gorges', user_id: user2.id })
...
photo7 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/Peaks2.jpg', title: 'Casco Bay', user_id: user2.id })
...
photo8 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/Peaks3.jpg', title: 'Sunset', user_id: user2.id })
...
photo9 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/Peaks4.jpg', title: "Ferry Landing: Welcome!", user_id: user2.id})
...
photo10 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/Peaks5.jpg', title: 'Portland Skyline', user_id: user2.id })
...
photo11 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/0002_PB160650.JPG', title: 'FEN by Caryl Churchill', user_id: user2.id, caption: 'Lighting Design by Ian Del Duca'})
...
photo12 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/0005_PB160627.JPG', title: 'FEN by Caryl Churchill', user_id: user2.id, caption: 'Lighting Design by Ian Del Duca'})
...
photo13 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/0011_PB160669.JPG', title: 'FEN by Caryl Churchill', user_id: user2.id, caption: 'Lighting Design by Ian Del Duca'})
...
photo14 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/0013_PB160622.JPG', title: 'FEN by Caryl Churchill', user_id: user2.id, caption: 'Lighting Design by Ian Del Duca'})
...
photo15 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/0015_PB160660.JPG', title: 'FEN by Caryl Churchill', user_id: user2.id, caption: 'Lighting Design by Ian Del Duca'})
...
photo16 = Photo.create({photo: 'https://s3.amazonaws.com/fflickr-dev/seeds/0017_PB160574.JPG', title: 'FEN by Caryl Churchill', user_id: user2.id, caption: 'Lighting Design by Ian Del Duca'})
