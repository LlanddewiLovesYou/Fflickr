...
photo11 = Photo.create({photo: File.open('app/assets/images/0002_PB160650.JPG'), title: 'FEN by Caryl Churchill', user_id: user3.id, caption: 'Lighting Design by Ian Del Duca'})
photoalbs11 = AlbPhoto.create({photo_id: photo11.id, album_id: album2.id})

photo12 = Photo.create({photo: File.open('app/assets/images/0005_PB160627.JPG'), title: 'FEN by Caryl Churchill', user_id: user3.id, caption: 'Lighting Design by Ian Del Duca'})
photoalbs12 = AlbPhoto.create({photo_id: photo12.id, album_id: album3.id})

photo13 = Photo.create({photo: File.open('app/assets/images/0011_PB160669.JPG'), title: 'FEN by Caryl Churchill', user_id: user3.id, caption: 'Lighting Design by Ian Del Duca'})
photoalbs13 = AlbPhoto.create({photo_id: photo13.id, album_id: album3.id})

photo14 = Photo.create({photo: File.open('app/assets/images/0013_PB160622.JPG'), title: 'FEN by Caryl Churchill', user_id: user3.id, caption: 'Lighting Design by Ian Del Duca'})
photoalbs14 = AlbPhoto.create({photo_id: photo14.id, album_id: album3.id})

photo15 = Photo.create({photo: File.open('app/assets/images/0015_PB160660.JPG'), title: 'FEN by Caryl Churchill', user_id: user3.id, caption: 'Lighting Design by Ian Del Duca'})
photoalbs15 = AlbPhoto.create({photo_id: photo15.id, album_id: album3.id})

photo16 = Photo.create({photo: File.open('app/assets/images/0017_PB160574.JPG'), title: 'FEN by Caryl Churchill', user_id: user3.id, caption: 'Lighting Design by Ian Del Duca'})
